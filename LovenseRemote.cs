...
namespace Lovense_Remote {
    public class LovenseRemote : MelonMod {
        ...
        public override void VRChat_OnUiManagerInit() {
            ...
            LockButtonUI = new QMSingleButton(menu, 3, 2, "Lock Speed\nButton", delegate () {
            ...
            HoldButtonUI = new QMSingleButton(menu, 2, 2, "Hold\nButton", delegate () {
            ...
            addButtonUI = new QMSingleButton(menu, 4, 2, "Add\nToys", delegate () {
            ...
            holdToggle = new QMToggleButton(menu, 1 + 1, 2 - 1, "Hold on", delegate () { 
