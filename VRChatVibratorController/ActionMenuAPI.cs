    ...
    internal class ActionMenuAPI
    {
        ...
        public ActionMenuAPI()
        {
            foreach (MethodBase methodBase in typeof(ActionMenu).GetMethods().Where(m => m.Name.StartsWith("Method") && checkXref(m, openMainPageKeyWords)))
            {
                ...
                VibratorController.HarmonyInstance.Patch(methodBase, new HarmonyMethod(typeof(ActionMenuAPI).GetMethod(nameof(OpenMainPagePre))), new HarmonyMethod(typeof(ActionMenuAPI).GetMethod(nameof(OpenMainPagePost))));
                break;
            }
          ...
          */
            foreach (MethodBase methodBase in typeof(ActionMenu).GetMethods().Where(m => m.Name.StartsWith("Method") && checkXref(m, openOptionsPageKeyWords)))
            {
                ...
                VibratorController.HarmonyInstance.Patch(methodBase, new HarmonyMethod(typeof(ActionMenuAPI).GetMethod(nameof(OpenOptionsPre))), new HarmonyMethod(typeof(ActionMenuAPI).GetMethod(nameof(OpenOptionsPost))));
                break;
            }
            /*
